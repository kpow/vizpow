/*
 * Si12T — Capacitive touch sensor driver (I2C 0x68)
...
void Si12T::begin()
{
    ...
    set_Ctrl2();
    set_Ctrl1();
    SI12T_Set_Sensitivity(sens_type, sens_level);
    SI12T_Get_Sensitivity();
}
...
{
    if (sens_type < SI12T_Type_Low || sens_type > SI12T_Type_High) return -1;

    uint8_t value = 0x00;
    if (sens_type == SI12T_Type_High) {
        switch (sens_level) {
            case SI12T_Sensitivity_Level_0: value = 0x88; break;
            case SI12T_Sensitivity_Level_1: value = 0x99; break;
            case SI12T_Sensitivity_Level_2: value = 0xAA; break;
            case SI12T_Sensitivity_Level_3: value = 0xBB; break;
            case SI12T_Sensitivity_Level_4: value = 0xCC; break;
            case SI12T_Sensitivity_Level_5: value = 0xDD; break;
            case SI12T_Sensitivity_Level_6: value = 0xEE; break;
            case SI12T_Sensitivity_Level_7: value = 0xFF; break;
            default: break;
        }
    } else {
        switch (sens_level) {
            case SI12T_Sensitivity_Level_0: value = 0x00; break;
            case SI12T_Sensitivity_Level_1: value = 0x11; break;
            case SI12T_Sensitivity_Level_2: value = 0x22; break;
            case SI12T_Sensitivity_Level_3: value = 0x33; break;
            case SI12T_Sensitivity_Level_4: value = 0x44; break;
            case SI12T_Sensitivity_Level_5: value = 0x55; break;
            case SI12T_Sensitivity_Level_6: value = 0x66; break;
            case SI12T_Sensitivity_Level_7: value = 0x77; break;
            default: break;
        }
    }
...
void Si12T::enable_channel(void)
{
    ...
    SI12T_Writeregister(SI12T_CH_HOLD1_ADDR, 0x00);
    SI12T_Writeregister(SI12T_CH_HOLD2_ADDR, 0x00);
    SI12T_Writeregister(SI12T_CAL_HOLD1_ADDR, 0x00);
    SI12T_Writeregister(SI12T_CAL_HOLD2_ADDR, 0x00);
